...
// TODO: Try and save these in json as a "project"
...
class _SourcesTabState extends State<SourcesTab>
  ...
  Future<void> _setSource(Source source) async {
    ...
    await player.getDuration().then((value) {
      if (value != null) {
        debugPrint("Length: ${value.inMilliseconds.toDouble()}");
        updateParentState(value.inMilliseconds.toDouble());
      } else {
        debugPrint("Length: null");
      }
    });*/
  ...
  Future<void> saveWidgetData() async {
    try {
      ...
      Map<String, dynamic> widgetData = {
        'setSourceKey': 'setSource-url-remote-wav-1',
        'title': 'Remote URL WAV 1',
        'subtitle': 'coins.wav',
        'source': wavUrl1, // Assuming wavUrl1 is a String
      };
      ...
      if (kIsWeb) {
        ...
        final anchor = html.document.createElement('a') as html.AnchorElement
          ...
          ..download = 'session.json'; // Name of the downloadable file
        ...
        File jsonFile = File('${appDocDir.path}/session.json');
  ...
  Future<void> loadWidgetData() async {
    try {
      if (kIsWeb) {
      ...
      input.onChange.listen((event) async {
        ...
        if (file != null) {
          ...
          setDataToView(reader.result as String);
        }
      });*/
        ...
        String jsonData = await DefaultAssetBundle.of(context)
            .loadString('assets/session.json');
        setDataToView(jsonData);
      }
    } catch (e) {
  ...
  void setDataToView(String jsonData) {
          ...
          (item) {
            if (item['title'] != null &&
              ...
              return _createSourceTile(
                setSourceKey: Key(item['setSourceKey']),
                title: item['title'],
                subtitle: item['subtitle'],
                source: UrlSource(item['source']),
              );
            } else {
              throw Exception('Missing data in JSON');
            }
          },
        ),
      );
